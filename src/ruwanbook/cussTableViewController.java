 ...
 * @author Bhashi
 */
public class cussTableViewController implements Initializable{
    @FXML
    TableView tblview;
   ...
   // private final ObservableList<Person> data =FXCollections.observableArrayList(new Person("A", "B"));
    private  ObservableList<Details> data=FXCollections.observableArrayList(new Details("", "","",""));
...
//        companyNameCol.setCellValueFactory(new PropertyValueFactory<>("Company"));
        ...
        tblview.getColumns().addAll(firstNameCol, lastNameCol,addressCol,phoneCol);
...
//                System.out.println("");
    ...
    public void backToCustomer(){
         try{
            ...
            RuwanBook.getStage().setTitle("Customers");
