 ...
 * @author Bhashi
 */
public class proTableViewController implements Initializable{
    @FXML
    TableView tblview;
   ...
   // private final ObservableList<Person> data =FXCollections.observableArrayList(new Person("A", "B"));
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        TableColumn firstNameCol = new TableColumn("Serial Number");
        ...
        TableColumn addressCol = new TableColumn("Description");
        addressCol.setMinWidth(100);
        addressCol.setCellValueFactory(new PropertyValueFactory<>("address"));
        
        TableColumn phoneCol = new TableColumn("Price");
        phoneCol.setMinWidth(100);
        phoneCol.setCellValueFactory(new PropertyValueFactory<>("Phone"));
        
        TableColumn companyNameCol = new TableColumn("Quantity");
...
//                System.out.println("");
    ...
    public void backToProduct(){
         try{
            ...
            RuwanBook.getStage().setTitle("Products");
            RuwanBook.getStage().setScene(scene);  
            RuwanBook.getStage().show();
          }catch(Exception e){}
    }
